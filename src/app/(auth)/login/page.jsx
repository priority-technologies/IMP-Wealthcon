					...
					<div className='m-auto sm:w-96 px-4'>
						...
						{/* <form>
							...
							>
								...
								email address. An OTP will be sent to the email address.
							</Typography>
							<Input
								type='email'
								id='email'
						...
						<form>
							...
							<Typography
								...
								className='block text-left pt-1 mb-4 mt-2'
							>
								Enter the OTP sent to - Example@email.com
							</Typography>
			...
			<dialog id='my_modal_1' className='modal' open={showTerms}>
				<div className='modal-box rounded-none py-10 bg-primary-content max-w-5xl w-full'>
					...
					<Typography
						...
						className='bloc mb-3'
					>
						TMP Wealthcon is an educational platform. It does not provide investment advice or tips, nor does it claim any guaranteed returns. All participants must conduct their own research before making investment decisions. TMP Wealthcon and its members are not liable for any losses.
					</Typography>
					<Typography
						tag='p'
						size='text-base'
					...
					>
						TMP Wealthcon does not sell investment products, plans, or policies, nor it is associated with any brokers or financial advisors. It also does not accept sponsorships from external entities, including pharmaceutical or insurance companies.
					</Typography>
					<Typography
						tag='p'
						size='text-base'
						...
						className='block mb-3'
					>
						Only MBBS/PG doctors can join TMP Wealthcon. 
					</Typography>
					<Typography
						tag='p'
						size='text-base'
					...
					<Typography
						...
						className='block mb-3'
					>
						Compliance: Scholars must adhere to TMP rules and not share course content with non-TMP individuals.
					</Typography>
					<Typography
						tag='p'
						size='text-base'
						...
						className='block mb-3'
					>
						1. I understand the risks involved in trading and investing, and I am aware of the unpredictable nature of financial markets. The responsibility for any trading or investment decisions, including potential losses, is entirely mine.
					</Typography>
					<Typography
						tag='p'
						size='text-base'
						...
						className='block mb-3'
					>
						2. I will abide by all trading rules taught in the course, including those on leverage, diversification, and position sizing.
					</Typography>
					<Typography
						tag='p'
						size='text-base'
						...
						className='block mb-3'
					>
						3. My immediate family members are aware of and support my decision to trade, fully understanding that any potential loss is my responsibility.
					</Typography>
					<Typography
						tag='p'
						size='text-base'
